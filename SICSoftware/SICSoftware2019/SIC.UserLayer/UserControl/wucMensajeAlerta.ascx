<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="wucMensajeAlerta.ascx.cs"
    Inherits="SIC.UserLayer.UserControl.wucMensajeAlerta" %>
        ...
        <table style="width: 320px">
            <tr style="background-color: #3E761C">
                <td align="left" class="style1">
                    <asp:Label ID="Label1" runat="server" Text="SICWEB - INDUMET" ForeColor="White" Font-Bold="true"></asp:Label>
    ...
    <div id="pie" style="width: 320px">
        <table width="320">
            <tr style="background-color: White">
                <td align="center">
                    <asp:Button ID="ibtnCancelar" runat="server" Text="Aceptar" BorderColor="#3E761C"
                        BackColor="#3E761C" Font-Size="XX-Small" ForeColor="White" />
                </td>
            </tr>
        </table>
    </div>
