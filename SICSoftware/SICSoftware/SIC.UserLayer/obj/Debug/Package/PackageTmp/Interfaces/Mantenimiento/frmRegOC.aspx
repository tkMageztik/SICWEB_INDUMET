...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <asp:UpdatePanel ID="upGeneral" UpdateMode="Conditional" runat="server">
        <ContentTemplate>
            <asp:MultiView ID="mvOC" runat="server" ActiveViewIndex="1">
                                                ...
                                                <tr>
                                                    ...
                                                    <td align="left" class="txt-box-estilo" colspan="2">
                                                        <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AlternatingRowStyle-CssClass="alt"
                                                            ...
                                                            EmptyDataText="No hay datos disponibles." GridLines="None" Height="16px" PagerStyle-CssClass="pgr"
